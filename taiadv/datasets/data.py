...
class DatasetGenerator():
    def __init__(self, exp=None, train_bs=128, eval_bs=256, seed=0,
                 n_workers=4, train_d_type='CIFAR10', test_d_type='CIFAR10',
        ...
        """
            ...
            Including MNIST, SVHN, CIFAR, ImageNet, see utils.py for more
            details
        """
