...
parser.add_argument("--dataset", type=str,
                    default='UNSW_NB15_training-set',
...
for file in data_lst:
    ...
    if "UNSW_NB15" in file:
        x_test, y_test = utils.read_UNSW(file="./dataset/UNSW_NB15_testing-set.csv",
                                        normalization=normalization,
                                        seed=42)
        x_train, y_train = utils.read_UNSW(file="./dataset/UNSW_NB15_training-set.csv",
                                        normalization=normalization,
                                        seed=42)
    else:
